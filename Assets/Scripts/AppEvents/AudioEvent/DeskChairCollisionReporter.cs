...
public class DeskChairCollisionReporter : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision c)
    {
        ...
        if (c.impulse.magnitude > 0.25f)
        {
            ...
            EventManager.TriggerEvent<CollideDeskChairEvent, Vector3, float>(c.contacts[0].point, c.impulse.magnitude);
        }
